...
Visual symptom → cause → treatment reference for plant health diagnosis.
...
- Fungus gnats hovering around plant
- Edema (blisters/bumps on leaves)
...
4. Remove any standing water from saucer
5. If fungus gnats: let soil dry completely, use sticky traps
6. **If root rot suspected:**
   - Remove from pot, shake off soil
   - Trim all brown/black/mushy roots with sterile scissors
   - Let roots air dry 1-2 hours
...
3. Mist leaves if plant tolerates humidity
...
- Add perlite to improve water retention
...
- Small new leaves
- Leaning strongly toward window
- Slow growth
- Variegation fading (variegated plants)
...
4. Consider grow lights for low-light spaces
...
4. Gradually reintroduce to brighter light over 2-3 weeks
...
4. Apply neem oil or insecticidal soap every 5-7 days
5. Increase humidity (mites hate humidity)
...
4. Check root ball — mealybugs hide in soil too
...
- Seedlings or weak plants may suffer root damage
...
4. Water with diluted hydrogen peroxide (1:4 ratio)
...
4. Apply horticultural oil or neem oil
...
4. Baking soda spray: 1 tbsp baking soda + 1 tsp dish soap per liter water
...
4. If less than 1/3 roots remain — propagate healthy parts instead
5. Let roots dry 1-2 hours
6. Repot in fresh, sterile soil with excellent drainage
7. Don't water for 7-10 days
...
4. Apply copper fungicide if severe
...
4. Remove severely damaged foliage
...
4. Mist regularly (if plant tolerates)
5. Move away from heating vents
...
|---------|--------------|---------|
| Yellow lower leaves, soft stems | Overwatering | 🔴 |
| Crispy brown edges | Underwatering OR low humidity | 🟡 |
| Leggy, stretched growth | Low light | 🟢 |
| White/bleached patches | Light burn | 🟡 |
...
| Wilting + wet soil + smell | Root rot | 🔴 |
| Yellow new leaves, green veins | Iron deficiency | 🟡 |
| Uniform yellow old leaves | Nitrogen deficiency | 🟡 |
| Purple tinge on leaves | Phosphorus deficiency | 🟢 |
| Brown tips only | Low humidity/fluoride | 🟢 |
| Sudden leaf drop | Temperature shock | 🟡 |
