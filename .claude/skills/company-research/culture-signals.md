...
- **Technical writing** — Engineers publish, documentation quality
...
- **Documentation** — Internal docs mentioned positively
...
- **Career ladders** — IC track, not just management
...
- **Remote inclusion** — Remote not second-class
- **Documented processes** — Knowledge accessible
...
- **High turnover** — Check Glassdoor tenure
...
- **Surveillance** — Monitoring tools mentioned
...
| Score | Meaning |
|-------|---------|
| ⭐⭐⭐⭐⭐ | Strong eng culture, multiple positive signals |
| ⭐⭐⭐⭐ | Good culture, some positive signals |
| ⭐⭐⭐ | Average, mixed signals |
| ⭐⭐ | Concerning, multiple negative signals |
