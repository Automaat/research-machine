...
**Minimum:** €160k total compensation
**Structure preference:** Base + equity over high variable
...
- **Stock Options** — ISO/NSO
  - Strike price important
  - Exercise window on departure
  - 409A valuation

- **Phantom Equity** — Be cautious
...
- **Learning** — Conference/education budget
- **PTO** — Unlimited vs fixed (check culture)

---

## Level Mapping

| Level | Typical Titles | Years Exp | Comp Range (EUR) |
|-------|----------------|-----------|------------------|
| L4/IC3 | Senior Engineer | 4-7y | €120-160k |
| L5/IC4 | Staff Engineer | 7-12y | €160-220k |
| L6/IC5 | Principal Engineer | 10+y | €200-280k |
| M1 | Engineering Manager | 5-8y | €140-180k |
| M2 | Senior EM | 8-12y | €180-240k |

*Ranges vary significantly by company stage and location*
...
- "How is performance bonus determined?"
...
**Ask:** "How do you approach compensation for remote workers in Europe?"
...
- ❌ No refresh grants
- ❌ Short exercise window (30-90 days)
...
### Market Data
- Levels.fyi range: $X-Y (€A-B)
- Glassdoor range: €C-D
- Known offers: [if found]

### Company Structure
- Base: [range if known]
- Equity: [RSU/Options, vesting]
- Bonus: [structure]
- Benefits: [notable]
...
1. [Comp-related question]
2. [Equity-related question]
```
