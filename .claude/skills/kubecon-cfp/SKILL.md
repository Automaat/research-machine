...
```
Read: cfp-criteria.md — scoring dimensions, character limits, format rules
Read: talk-patterns.md — title patterns, topic trends, acceptance data
Read: findings/kubecon-cfp/cfp-writing-guide.md — full research
Read: findings/kubecon-cfp/accepted-talks-analysis-2024-2025.md — talk analysis
```
...
Generate 5 title options using proven patterns from [talk-patterns.md](talk-patterns.md). Re-read the title patterns section before generating.
...
Score the submission against the 4 official criteria from [cfp-criteria.md](cfp-criteria.md) (1-5 scale): Content, Originality, Relevance, Speaker(s).

Run the pre-submit checklist from [cfp-criteria.md](cfp-criteria.md) and flag issues.
...
Read [references/output-template.md](references/output-template.md) for the submission format. Save to `findings/kubecon-cfp/submissions/[title-slugified].md`.
