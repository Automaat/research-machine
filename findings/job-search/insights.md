...
|--------|---------------|-------|
| Poland | €76-85k | Below target, local market rates |
...
| Remote Global (US rates) | €150-250k | Rare, usually US companies |

### By Company Stage

| Stage | Typical Range | Can Hit €160k+? |
|-------|---------------|-----------------|
| Pre-seed/Seed | €50-90k | ❌ Rarely |
| Series A | €80-120k | ⚠️ Unlikely |
| Series B | €100-150k | ⚠️ Maybe (top of range) |
| Series C+ | €130-200k | ✅ Yes |
